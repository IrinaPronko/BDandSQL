...
CREATE TABLE comments (
    ...
    FOREIGN KEY (user_id) REFERENCES users(id)
) COMMENT 'комментарии к медиа файлу';
...
) COMMENT 'связь media и comments';
...
INSERT INTO `users` 
VALUES ('1','Семенов','Александр','semen@yandex.ru','shajkdhv','79104384590'),
    ('2','Кошечкин','Андрей','koshak@yandex.ru','lkfnvb','79134531298'),
    ('3','Иванова','Маргарита','margo@yandex.ru','qpweorj','79010233456'),
    ('4','Лютикова','Александра','lyutik@yandex.ru','47fjiwew','79286034511'),
    ('5','Медведев','Владимир','medv@yandex.ru','x7634jfpdsc','79035432918'),
    ('6','Кабанов','Андрей','kaban@yandex.ru','239ucbw','79053458541'),
    ('7','Соколов','Игорь','sokol@yandex.ru','31_0ifmveq','79657910015'),
    ('8','Цветаева','Светлана','cvetik@yandex.ru','2132fvqee3','79211054678'),
    ('9','Полькина','Ирина','polka@yandex.ru','ldfjn','79023415519'),
    ('10','Сумкина','Валентина','suma@yandex.ru','qwerty','79230031412');
...
по умолчанию = true (или 1) (ALTER TABLE + UPDATE)
*/
